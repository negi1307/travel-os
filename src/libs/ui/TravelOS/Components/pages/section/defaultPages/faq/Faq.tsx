...
const Faq = (props: any) => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer:
        'Yes, we are a pet-friendly hotel. There may be additional charges for bringing pets.',
    },
    {
      question: 'Is there a restaurant on-site?',
      answer:
        'Yes, we have an on-site restaurant that serves a variety of delicious dishes.',
    },
    {
      question: 'Do you have a fitness center or gym?',
      answer:
        'Yes, we have a well-equipped fitness center available for our guests.',
    },
    {
      question: 'Is the hotel accessible for people with disabilities?',
      answer:
        'Yes, our hotel is wheelchair accessible, and we have facilities for people with disabilities.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Yes, we provide airport shuttle services for our guests. Please contact us for more details.',
    },
  ];
  ...
  return (
    <Box sx={containerStyle}>
      ...
      <Box mt={5} p={5} px={10}>
        <Typography
          variant="subtitle2"
          sx={{ fontFamily: 'Averta PE', textAlign: 'left' }}
        >
          ...
          {faqData.map((faq, index) => (
            ...
            >
              ...
              >
                ...
                <Typography
                  px={2}
                  sx={{ fontFamily: 'Inter', lineHeight: '16.94px' }}
                  variant="h6"
                >
                  {faq.question}
                </Typography>
