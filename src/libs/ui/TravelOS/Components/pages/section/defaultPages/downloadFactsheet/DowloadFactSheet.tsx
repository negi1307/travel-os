  ...
  return (
    <>
      ...
      >
          ...
          <Grid item xs={12} sm={8} md={6.5} sx={{ paddingRight: '3%' }}>
            ...
            >
              ...
              <Select
                ...
                label="Choose"
              >
                <MenuItem className="my-ac-select-menu" value={10}>
                  Atlantis, The Palm
                </MenuItem>
                <MenuItem className="my-ac-select-menu" value={20}>
                  Atlantis The Royal
                </MenuItem>
                <MenuItem className="my-ac-select-menu" value={30}>
                  Atlantis Sanya
                </MenuItem>
              </Select>
            </FormControl>
        ...
        <Grid container spacing={5} px={5} py={2} marginTop={1}>
